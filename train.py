...
parser.add_argument("--model", type=str, default='pudiff')
parser.add_argument('--log_dir', default='logs/pudiff_baseline', help='Log dir [default: logs/test_log]')
...
if __name__ == '__main__':
    ...
    for epoch in range(args.max_epoch):
        ...
        for batch in train_loader:
            ...
            preds = model.get_pred_for_loss(input_data)
        ...
        if (epoch + 1) % 20 == 0:
            ...
            save_path = os.path.join(args.log_dir, 'pudiff_epoch_{}.pth'.format(epoch))
